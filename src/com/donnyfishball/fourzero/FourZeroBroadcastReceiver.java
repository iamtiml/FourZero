 ...
 */
public class FourZeroBroadcastReceiver extends FacebookBroadcastReceiver {

    @Override
    protected void onSuccessfulAppCall(String appCallId, String action, Bundle extras) {
        // A real app could update UI or notify the user that their photo was uploaded.
        Log.d("FourZero", String.format("Photo uploaded by call " + appCallId + " succeeded."));
    }
    ...
    protected void onFailedAppCall(String appCallId, String action, Bundle extras) {
        ...
        Log.d("FourZero", String.format("Photo uploaded by call " + appCallId + " failed."));
    }
}
